package com.example.safespace.fragments
...
class MapsFragment : Fragment(),OnMapReadyCallback {
    ...
    // not granted.
    private val defaultLocation = LatLng(32.0, 34.0)
...
//    this.map?.setInfoWindowAdapter(object a : GoogleMap.InfoWindowAdapter
//    {
//        // Return null here, so that getInfoContents() is called next.
//        override fun getInfoWindow(arg0: Marker): View? {
//            return null
